...
def main() -> None:
    ...
    RAMP_STEP_QPPS = 250  # same increment used in test_version_2.py loops, this was 500 below
    FORWARD_TARGET_QPPS = 250 * 20  # treat as ~"half speed" target in QPPS, this was 500 below
    TURN_QPPS = 250 * 10  # turning speed magnitude, this was 500 below
